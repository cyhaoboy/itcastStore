package com.example.itcaststore.service;
import com.example.itcaststore.dao.ProductDao;
...
import com.example.itcaststore.exception.AddProductException;
import com.example.itcaststore.exception.FindProductByIdException;
...
public class ProductService {
	...
	public  PageBean queryProduct(int currentPage,int currentCount){
		...
		try {
			...
			List<Product> ps = dao.queryByPage(currentPage, currentCount);
			bean.setPs(ps);
		} catch (SQLException e) {
			e.printStackTrace();
		}
