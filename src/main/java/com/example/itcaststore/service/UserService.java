...
import com.example.itcaststore.dao.UserDao;
...
import com.example.itcaststore.utils.MailUtils;
...
public class UserService {
	...
	public int register(User user) throws RegisterException {
		...
		try {
			...
			String emailMsg = "感谢您注册网上书城，点击"
					+ "<a href='https://localhost:8080/itcastStore/activeUser?activeCode="
	...
	public void test(){
		...
		user.setEmail("1305183428@qq.com");
		try {
			register(user);
